...
public class CardDrag : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
	...
	[SerializeField] private float dragDelay = 1f;
